...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" className="bg-gradient-to-b from-secondary/50 to-background py-24">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="glass-card rounded-2xl p-8 md:p-12 animate-scale-in">
            ...
            <div className="absolute -bottom-5 -right-5 w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center">
          ...
          <div className="hidden sm:flex justify-between absolute top-1/2 -translate-y-1/2 left-0 right-0 px-4">
            <button
              onClick={prev}
              className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-primary hover:text-white transition-colors duration-200"
